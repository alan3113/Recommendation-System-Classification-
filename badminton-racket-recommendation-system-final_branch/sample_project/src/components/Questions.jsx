const questions = [
  ...
  },
  {
    ...
    options: [
      { value: 1800, details: "Budget rackets suitable for beginners or casual play." },
      { value: 2000, details: "Mid-range rackets that offer good quality and performance for intermediate players." },
      { value: 2200, details: "High-quality rackets suitable for advanced players looking for better performance and durability." },
      { value: 2400, details: "Premium rackets designed for professional players, offering the best materials and technology for top performance." }
    ]
  }
];
