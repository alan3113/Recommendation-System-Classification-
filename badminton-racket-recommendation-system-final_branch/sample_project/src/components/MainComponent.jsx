    ...
    return (
        <>
            ...
            { 
                ...
                recommendation.length != 0 && <Collapsible recommendation={recommendation}/>
            ...
            <div className="right-div ">
                <div className="flex flex-col h-full pt-20 w-full">
                    ...
                    { 
                    userType === userTypesConst[1] && 
                        <ExistingUserComponent setRecommendation={setRecommendation}/>
                    }
                    
                    {userType === userTypesConst[0] && <NewUserComponent setRecommendation={setRecommendation}/>}
