...
const NewUserComponent = (setRecommendation) => {
    ...
    <div className="flex flex-col h-full w-full items-center px-4 md:px-8 lg:px-16 xl:px-20">
      ...
      <div className="flex justify-between w-full mt-4">
        ...
        {currentQuestion < questions.length - 1 ? (
          ...
          isNextEnabled && <GetRecommendationComponent setRecommendation={setRecommendation} requestBody={answers} userType={"newUser"}/>
        )}
        </div>
      </div>
    </div>
